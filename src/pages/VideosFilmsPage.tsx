  ...
  return (
    <main className="w-full flex flex-col px-8 py-12 bg-gray-100 font-selectric">
      <div className="flex flex-col items-center">
        ...
        <p className="w-96 text-gray-800 italic text-center">“Lost In The Wash” is a new experimental feature film by Rbt. Sps. currently still in production. Tyler J. Ladd stars alongside Sps. himself in this eclectic travelogue.</p>
